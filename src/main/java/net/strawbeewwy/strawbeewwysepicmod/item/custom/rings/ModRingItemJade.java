...
public class ModRingItemJade extends ModRingItem{
    public ModRingItemJade(Settings settings) {
        super(settings);
    }
    ...
    public Multimap<EntityAttribute, EntityAttributeModifier> getModifiers(ItemStack stack, SlotReference slot, LivingEntity entity, UUID uuid) {
        ...
        modifiers.put(EntityAttributes.GENERIC_MOVEMENT_SPEED, new EntityAttributeModifier(uuid, "strawbeewwysepicmod:speed",
                0.05 + quality, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));

        modifiers.put(EntityAttributes.GENERIC_MAX_HEALTH, new EntityAttributeModifier(uuid, "strawbeewwysepicmod:speed",
