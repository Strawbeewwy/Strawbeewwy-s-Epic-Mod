    ...
    public void tick(ItemStack stack, SlotReference slot, LivingEntity entity) {
        ...
        if (friend!= null) {
            if (friend.getPos().isInRange(entity.getPos(),effectiveRadius)) {
                entity.addStatusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 5 * TPS, effectAmplifier));
                entity.addStatusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 5 * TPS, effectAmplifier));
            }
        }
    }
