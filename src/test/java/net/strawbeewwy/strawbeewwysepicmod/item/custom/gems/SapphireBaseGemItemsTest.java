...
class SapphireBaseGemItemsTest {
    ...
    public void onCraftShouldHaveGemQuality() {
        ...
        cases.put("chipped_sapphire",301);
        cases.put("flawed_sapphire",302);
        cases.put("sapphire",303);
        cases.put("brilliant_sapphire", 304);
        cases.put("pristine_sapphire",305);

        for (var test:cases.entrySet()) {

            var item = new SapphireBaseGemItems(new Item.Settings());
