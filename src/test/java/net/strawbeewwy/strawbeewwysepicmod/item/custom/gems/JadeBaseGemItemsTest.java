...
class JadeBaseGemItemsTest {
    ...
    public void onCraftShouldHaveGemQuality() {
        ...
        cases.put("chipped_jade",101);
        cases.put("flawed_jade",102);
        cases.put("jade",103);
        cases.put("brilliant_jade", 104);
        cases.put("pristine_jade",105);

        for (var test:cases.entrySet()) {

            var item = new JadeBaseGemItems(new Item.Settings());
